            ...
            <div class="col px-0">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7 text-center pt-lg">
                        ...
                        <p class="lead text-white mt-4 mb-5">En vez de Argon iría el logo de la Marca ql.</p>
                ...
                <div class="row align-items-center justify-content-around stars-and-coded">
                    <div class="col-sm-4">
                        <span class="text-white alpha-7 ml-3">Algo de texto</span>
                    </div>
                    <div class="col-sm-4 mt-4 mt-sm-0 text-right">
                        <span class="text-white alpha-7">Algo por aca</span>
                    </div>
                    <!--
                    <div class="col-sm-4">
