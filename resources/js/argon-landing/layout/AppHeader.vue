            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                <base-dropdown class="nav-item" menu-classes="dropdown-menu-xl">
                    <a slot="title" href="#" class="nav-link" data-toggle="dropdown" role="button">
                        ...
                        <span class="nav-link-inner--text">Menu Pulento</span>
                    </a>
                    <div class="dropdown-menu-inner">
                        <a href="#"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <h6 class="heading text-primary mb-md-1">Super Duper Servicio</h6>
                        ...
                        <a href="#"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <h5 class="heading text-warning mb-md-1">Lo mismo de arriba</h5>
                ...
                <base-dropdown tag="li" class="nav-item">
                    <a slot="title" href="#" class="nav-link" data-toggle="dropdown" role="button">
                        ...
                        <span class="nav-link-inner--text">Menu piola</span>
                    </a>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <span class="btn-inner--icon">
                  <i class="fa fa-cloud-download mr-2"></i>
                        ...
                        <span class="nav-link-inner--text">Boton ql bonito</span>
                    </a>
                </li>
            </ul>
        </base-nav>
...
<script>
import BaseNav from "@argon-landing/components/BaseNav";
import BaseDropdown from "@argon-landing/components/BaseDropdown";
import CloseButton from "@argon-landing/components/CloseButton";
